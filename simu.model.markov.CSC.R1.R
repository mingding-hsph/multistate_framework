...
###data 2
  ...
  pfit23 <- predict(cfit2, newdata = new_data2, cause = 3, times =break_interval, se = TRUE, keep.newdata = FALSE)
  pfit24 <- predict(cfit2, newdata = new_data2, cause = 4, times =break_interval, se = TRUE, keep.newdata = FALSE)
  
  predict2<-data.frame(new_data2$interval,  
                         pfit23$absRisk, pfit23$absRisk.se, 
                         pfit24$absRisk, pfit24$absRisk.se)
  
  colnames(predict2)=c("interval","r23", "se_r23","r24", "se_r24")
