...
anc.ev=c(0.3,0.5)  ##anc.ev is the shape
...
nsit=2 
dist.ev=c("weibull","weibull")
anc.ev=c(1.2,1.4)  ##anc.ev is the shape
...
nsit=1
dist.ev=c("weibull")
anc.ev=c(0.5)  ##anc.ev is the shape
...
nsit=1
dist.ev=c("weibull")
anc.ev=c(1.2)  ##anc.ev is the shape
...
nsit=1
dist.ev=c("weibull")
anc.ev=c(2)  ##anc.ev is the shape
...
nsit=1
dist.ev=c("weibull")
anc.ev=c(3)  ##anc.ev is the shape
...
true_non_markov_weilbull=t(rbind(
true0_1234[1:5,],
true0_1234[6:10,],
true0_1234[11:15,],
true0_1234[16:20,],
...
colnames(true_non_markov_weilbull)=cbind("s1", "s2", "s3","s4", 
                                         "s12", "s13", "s14", 
                                         "s23_0","s24_0", "s23_01",  "s24_01",
                                    "s34_0","s34_01", "s34_02", "s34_012")

rownames(true_non_markov_weilbull)=cbind("t1","t2","t3","t4","t5")

write.table(true_non_markov_weilbull, 
            "/Users/mingding/Library/CloudStorage/OneDrive-UniversityofNorthCarolinaatChapelHill/a4.CHD.dynamics/a.paper1/Rcode/true_non_markov_weilbull.txt")
