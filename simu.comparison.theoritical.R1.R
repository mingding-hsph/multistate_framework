...
setwd("/Users/mingding/Library/CloudStorage/OneDrive-UniversityofNorthCarolinaatChapelHill/a4.CHD.dynamics/a.paper1/Rcode/")
...
#tr_matrix=read.table("./true_non_markov_exp.txt")
#setwd("./5.constant.nonmarkov.data")

#source("./Theortical_data3.R")
#tr_matrix=read.table("./true_markov_weilbull.txt")
#setwd("./5.nonconstant.markov.data")

source("./Theortical_data4.R")
tr_matrix=read.table("./true_non_markov_weilbull.txt")
setwd("./5.nonconstant.nonmarkov.data")

con.mar_t1 = stringr::str_sort(list.files(pattern="TR_t1_.*txt", path="./markov.model/", full.names=TRUE), num = TRUE)
con.mar_t2 = stringr::str_sort(list.files(pattern="TR_t2_.*txt", path="./markov.model/", full.names=TRUE), num = TRUE)
con.mar_t3 = stringr::str_sort(list.files(pattern="TR_t3_.*txt", path="./markov.model/", full.names=TRUE), num = TRUE)
con.mar_t4 = stringr::str_sort(list.files(pattern="TR_t4_.*txt", path="./markov.model/", full.names=TRUE), num = TRUE)
con.mar_t5 = stringr::str_sort(list.files(pattern="TR_t5_.*txt", path="./markov.model/", full.names=TRUE), num = TRUE)
...
width_markov_t1 <-width_markov_t1 %>%
  mutate(
    ...
    tr_b = rowMedians(as.matrix(across(c(tr12_b, tr13_b, tr14_b, tr15_b, tr23_b, 
                             tr24_b, tr25_b, tr34_0_b, tr35_0_b,tr34_1_b, tr35_1_b, 
                             tr45_0_b,tr45_1_b,tr45_2_b,tr45_12_b)), na.rm=T)),
    
    tr_mes = rowMedians(as.matrix(across(c(tr12_mes, tr13_mes, tr14_mes, tr15_mes, tr23_mes, 
                               tr24_mes, tr25_mes, tr34_0_mes, tr35_0_mes,tr34_1_mes, tr35_1_mes, 
                               tr45_0_mes,tr45_1_mes,tr45_2_mes,tr45_12_mes)), na.rm=T)),
    
    tr_cover = rowMedians(as.matrix(across(c(tr12_cover, tr13_cover, tr14_cover, tr15_cover, tr23_cover, 
...
markov_width_t1=median(c(width_markov_t1$tr_b), na.rm=T)
markov_mes_t1=median(c(width_markov_t1$tr_mes), na.rm=T)
markov_coverage_t1=median(c(width_markov_t1$tr_cover), na.rm=T)
...
markov_width_t2=median(c(width_markov_t2$tr_b), na.rm=T)
markov_mes_t2=median(c(width_markov_t2$tr_mes), na.rm=T)
markov_coverage_t2=median(c(width_markov_t2$tr_cover), na.rm=T)
...
markov_width_t3=median(c(width_markov_t3$tr_b), na.rm=T)
markov_mes_t3=median(c(width_markov_t3$tr_mes), na.rm=T)
markov_coverage_t3=median(c(width_markov_t3$tr_cover), na.rm=T)
...
markov_width_t4=median(c(width_markov_t4$tr_b), na.rm=T)
markov_mes_t4=median(c(width_markov_t4$tr_mes), na.rm=T)
markov_coverage_t4=median(c(width_markov_t4$tr_cover), na.rm=T)
...
markov_width_t5=median(c(width_markov_t5$tr_b), na.rm=T)
markov_mes_t5=median(c(width_markov_t5$tr_mes), na.rm=T)
markov_coverage_t5=median(c(width_markov_t5$tr_cover), na.rm=T)
...
nonmarkov_width_t1=median(c(width_nonmarkov_t1$tr_b), na.rm=T)
nonmarkov_mes_t1=median(c(width_nonmarkov_t1$tr_mes), na.rm=T)
nonmarkov_coverage_t1=median(c(width_nonmarkov_t1$tr_cover), na.rm=T)
...
nonmarkov_width_t2=median(c(width_nonmarkov_t2$tr_b), na.rm=T)
nonmarkov_mes_t2=median(c(width_nonmarkov_t2$tr_mes), na.rm=T)
nonmarkov_coverage_t2=median(c(width_nonmarkov_t2$tr_cover), na.rm=T)
...
nonmarkov_width_t3=median(c(width_nonmarkov_t3$tr_b), na.rm=T)
nonmarkov_mes_t3=median(c(width_nonmarkov_t3$tr_mes), na.rm=T)
nonmarkov_coverage_t3=median(c(width_nonmarkov_t3$tr_cover), na.rm=T)
...
nonmarkov_width_t4=median(c(width_nonmarkov_t4$tr_b), na.rm=T)
nonmarkov_mes_t4=median(c(width_nonmarkov_t4$tr_mes), na.rm=T)
nonmarkov_coverage_t4=median(c(width_nonmarkov_t4$tr_cover), na.rm=T)
...
nonmarkov_width_t5=median(c(width_nonmarkov_t5$tr_b), na.rm=T)
nonmarkov_mes_t5=median(c(width_nonmarkov_t5$tr_mes), na.rm=T)
nonmarkov_coverage_t5=median(c(width_nonmarkov_t5$tr_cover), na.rm=T)
...
markov_width=median(c(markov_width_t1, markov_width_t2,markov_width_t3,
                    markov_width_t4,markov_width_t5), na.rm=T)
markov_mes=median(c(markov_mes_t1, markov_mes_t2,markov_mes_t3,
                  markov_mes_t4,markov_mes_t5), na.rm=T)

markov_coverage=median(c(markov_coverage_t1, markov_coverage_t2,markov_coverage_t3,
                       markov_coverage_t4,markov_coverage_t5), na.rm=T)


nonmarkov_width=median(c(nonmarkov_width_t1, nonmarkov_width_t2,nonmarkov_width_t3,
                       nonmarkov_width_t4,nonmarkov_width_t5), na.rm=T)

nonmarkov_mes=median(c(nonmarkov_mes_t1, nonmarkov_mes_t2,nonmarkov_mes_t3,
                     nonmarkov_mes_t4,nonmarkov_mes_t5), na.rm=T)

nonmarkov_coverage=median(c(nonmarkov_coverage_t1, nonmarkov_coverage_t2,nonmarkov_coverage_t3,
...
markov_tr12_width<-median(c(rowMedians(markov_tr12_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr12_mes<-median(c(rowMedians(markov_tr12_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr12_cover<-median(c(rowMedians(markov_tr12_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr13_width<-median(c(rowMedians(markov_tr13_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr13_mes<-median(c(rowMedians(markov_tr13_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr13_cover<-median(c(rowMedians(markov_tr13_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr14_width<-median(c(rowMedians(markov_tr14_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr14_mes<-median(c(rowMedians(markov_tr14_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr14_cover<-median(c(rowMedians(markov_tr14_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr15_width<-median(c(rowMedians(markov_tr15_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr15_mes<-median(c(rowMedians(markov_tr15_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr15_cover<-median(c(rowMedians(markov_tr15_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr23_width<-median(c(rowMedians(markov_tr23_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr23_mes<-median(c(rowMedians(markov_tr23_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr23_cover<-median(c(rowMedians(markov_tr23_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr24_width<-median(c(rowMedians(markov_tr24_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr24_mes<-median(c(rowMedians(markov_tr24_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr24_cover<-median(c(rowMedians(markov_tr24_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr25_width<-median(c(rowMedians(markov_tr25_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr25_mes<-median(c(rowMedians(markov_tr25_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr25_cover<-median(c(rowMedians(markov_tr25_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr34_0_width<-median(c(rowMedians(markov_tr34_0_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr34_0_mes<-median(c(rowMedians(markov_tr34_0_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr34_0_cover<-median(c(rowMedians(markov_tr34_0_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr34_1_width<-median(c(rowMedians(markov_tr34_1_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr34_1_mes<-median(c(rowMedians(markov_tr34_1_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr34_1_cover<-median(c(rowMedians(markov_tr34_1_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr35_0_width<-median(c(rowMedians(markov_tr35_0_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr35_0_mes<-median(c(rowMedians(markov_tr35_0_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr35_0_cover<-median(c(rowMedians(markov_tr35_0_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr35_1_width<-median(c(rowMedians(markov_tr35_1_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr35_1_mes<-median(c(rowMedians(markov_tr35_1_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr35_1_cover<-median(c(rowMedians(markov_tr35_1_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr45_0_width<-median(c(rowMedians(markov_tr45_0_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr45_0_mes<-median(c(rowMedians(markov_tr45_0_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr45_0_cover<-median(c(rowMedians(markov_tr45_0_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr45_1_width<-median(c(rowMedians(markov_tr45_1_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr45_1_mes<-median(c(rowMedians(markov_tr45_1_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr45_1_cover<-median(c(rowMedians(markov_tr45_1_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr45_2_width<-median(c(rowMedians(markov_tr45_2_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr45_2_mes<-median(c(rowMedians(markov_tr45_2_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr45_2_cover<-median(c(rowMedians(markov_tr45_2_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
markov_tr45_12_width<-median(c(rowMedians(markov_tr45_12_width_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr45_12_mes<-median(c(rowMedians(markov_tr45_12_mes_matrix[,1:5], na.rm=T)), na.rm=T)
markov_tr45_12_cover<-median(c(rowMedians(markov_tr45_12_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr12_width<-median(c(rowMedians(nonmarkov_tr12_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr12_mes<-median(c(rowMedians(nonmarkov_tr12_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr12_cover<-median(c(rowMedians(nonmarkov_tr12_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr13_width<-median(c(rowMedians(nonmarkov_tr13_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr13_mes<-median(c(rowMedians(nonmarkov_tr13_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr13_cover<-median(c(rowMedians(nonmarkov_tr13_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr14_width<-median(rowMedians(nonmarkov_tr14_width_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr14_mes<-median(rowMedians(nonmarkov_tr14_mes_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr14_cover<-median(rowMedians(nonmarkov_tr14_cover_matrix[,1:5], na.rm=T), na.rm=T)
...
nonmarkov_tr15_width<-median(rowMedians(nonmarkov_tr15_width_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr15_mes<-median(rowMedians(nonmarkov_tr15_mes_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr15_cover<-median(rowMedians(nonmarkov_tr15_cover_matrix[,1:5], na.rm=T), na.rm=T)
...
nonmarkov_tr23_width<-median(rowMedians(nonmarkov_tr23_width_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr23_mes<-median(rowMedians(nonmarkov_tr23_mes_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr23_cover<-median(rowMedians(nonmarkov_tr23_cover_matrix[,1:5], na.rm=T), na.rm=T)
...
nonmarkov_tr24_width<-median(rowMedians(nonmarkov_tr24_width_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr24_mes<-median(rowMedians(nonmarkov_tr24_mes_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr24_cover<-median(rowMedians(nonmarkov_tr24_cover_matrix[,1:5], na.rm=T), na.rm=T)
...
nonmarkov_tr25_width<-median(rowMedians(nonmarkov_tr25_width_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr25_mes<-median(rowMedians(nonmarkov_tr25_mes_matrix[,1:5], na.rm=T), na.rm=T)
nonmarkov_tr25_cover<-median(rowMedians(nonmarkov_tr25_cover_matrix[,1:5], na.rm=T), na.rm=T)
...
nonmarkov_tr34_0_width<-median(c(rowMedians(nonmarkov_tr34_0_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr34_0_mes<-median(c(rowMedians(nonmarkov_tr34_0_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr34_0_cover<-median(c(rowMedians(nonmarkov_tr34_0_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr34_1_width<-median(c(rowMedians(nonmarkov_tr34_1_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr34_1_mes<-median(c(rowMedians(nonmarkov_tr34_1_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr34_1_cover<-median(c(rowMedians(nonmarkov_tr34_1_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr35_0_width<-median(c(rowMedians(nonmarkov_tr35_0_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr35_0_mes<-median(c(rowMedians(nonmarkov_tr35_0_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr35_0_cover<-median(c(rowMedians(nonmarkov_tr35_0_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr35_1_width<-median(c(rowMedians(nonmarkov_tr35_1_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr35_1_mes<-median(c(rowMedians(nonmarkov_tr35_1_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr35_1_cover<-median(c(rowMedians(nonmarkov_tr35_1_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr45_0_width<-median(c(rowMedians(nonmarkov_tr45_0_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr45_0_mes<-median(c(rowMedians(nonmarkov_tr45_0_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr45_0_cover<-median(c(rowMedians(nonmarkov_tr45_0_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr45_1_width<-median(c(rowMedians(nonmarkov_tr45_1_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr45_1_mes<-median(c(rowMedians(nonmarkov_tr45_1_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr45_1_cover<-median(c(rowMedians(nonmarkov_tr45_1_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr45_2_width<-median(c(rowMedians(nonmarkov_tr45_2_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr45_2_mes<-median(c(rowMedians(nonmarkov_tr45_2_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr45_2_cover<-median(c(rowMedians(nonmarkov_tr45_2_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
nonmarkov_tr45_12_width<-median(c(rowMedians(nonmarkov_tr45_12_width_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr45_12_mes<-median(c(rowMedians(nonmarkov_tr45_12_mes_matrix[,1:5], na.rm=T)), na.rm=T)
nonmarkov_tr45_12_cover<-median(c(rowMedians(nonmarkov_tr45_12_cover_matrix[,1:5], na.rm=T)), na.rm=T)
...
table_simu=cbind(
  rbind(markov_mes, markov_width, markov_coverage),
  rbind(nonmarkov_mes, nonmarkov_width, nonmarkov_coverage)
)
...
write.table(table_simu,"./a.summary.results.txt")

write.table(tr_mes,"./a.by.tr.mes.txt")
write.table(tr_width,"./a.by.tr.width.txt")
write.table(tr_cover*100,"./a.by.tr.cover.txt")
