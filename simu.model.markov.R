...
table(data2_long$S2_y_4)
  
cfit23 <- coxph(Surv(tte_cmr,S2_y_3) ~ 
                 rcs(interval,3), data = data2_long, x = TRUE)
...
##convert rate to hazard
  ...
  write.table(TR_t1_table, file.path("./markov.model/", paste0("TR_t1_",ps,".txt")))
  write.table(TR_t2_table, file.path("./markov.model/", paste0("TR_t2_",ps,".txt")))
  write.table(TR_t3_table, file.path("./markov.model/", paste0("TR_t3_",ps,".txt")))
  write.table(TR_t4_table, file.path("./markov.model/", paste0("TR_t4_",ps,".txt")))
  write.table(TR_t5_table, file.path("./markov.model/", paste0("TR_t5_",ps,".txt")))
  ...
  write.table(TP_t1_table, file.path("./markov.model/", paste0("TP_t1_",ps,".txt")))
  write.table(TP_t2_table, file.path("./markov.model/", paste0("TP_t2_",ps,".txt")))
  write.table(TP_t3_table, file.path("./markov.model/", paste0("TP_t3_",ps,".txt")))
  write.table(TP_t4_table, file.path("./markov.model/", paste0("TP_t4_",ps,".txt")))
  write.table(TP_t5_table, file.path("./markov.model/", paste0("TP_t5_",ps,".txt")))
