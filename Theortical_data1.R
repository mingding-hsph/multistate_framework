...
colnames(true_markov_exp)=cbind("s1", "s2", "s3","s4", 
                                         "s12", "s13", "s14", 
                                         "s23_0","s24_0", "s23_01",  "s24_01",
                                    "s34_0","s34_01", "s34_02", "s34_012")

rownames(true_markov_exp)=cbind("t1","t2","t3","t4","t5")

write.table(true_markov_exp, 
            "/Users/mingding/Library/CloudStorage/OneDrive-UniversityofNorthCarolinaatChapelHill/a4.CHD.dynamics/a.paper1/Rcode/true_markov_exp.txt")
